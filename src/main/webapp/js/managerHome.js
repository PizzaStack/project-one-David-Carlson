...
function startEmployeeHome() {
    ...
    function getReimbursements() {
        ...
        // Set up our request
        XHR.open("POST", "http://localhost:8080/reimbursements", true);
    ...
    function turnIntoPendingRow(pRow) {
        ...
        return `
            <tr>
                ...
                <td><a class='btn btn-success' href="/reimbursements/resolve?resolution=Approved&id=${pRow.id}">Approve</a></td>
                <td><a class='btn btn-danger' href="/reimbursements/resolve?resolution=Denied&id=${pRow.id}">Deny</a></td>
    ...
    var resolvedBody = document.getElementById('resolved-tbody');
    var getImage = {
        0 : "https://www.freeagent.com/components/images/netlify/blog__will-hmrc-accept-scanned-receipts-for-business-expenses__receipt-shoebox-1-blog-21db8305.png",
